...
// SOURCE-MAP-REQUIRED
const core = __importStar(require("./opcua-iiot-core"));
const fsm_1 = require("@xstate/fsm");
const opcua_iiot_core_1 = require("./opcua-iiot-core");
var logger;
(function (logger) {
    logger.internalDebugLog = core.Debug('opcuaIIoT:connector');
    logger.detailDebugLog = core.Debug('opcuaIIoT:connector:details');
    logger.libDebugLog = core.Debug('opcuaIIoT:connector:nodeopcua');
})(logger = exports.logger || (exports.logger = {}));
// sets values within node.iiot (refactored to node.iiot)
const initConnectorNode = () => {
    return Object.assign(Object.assign({}, core.initCoreNode()), { sessionNodeRequests: 0, endpoints: [], userIdentity: undefined, opcuaClient: undefined, opcuaSession: undefined, discoveryServer: undefined, serverCertificate: undefined, discoveryServerEndpointUrl: undefined, hasOpcUaSubscriptions: false });
};
const createConnectorFinalStateMachine = function () {
    return (0, fsm_1.createMachine)({
        id: 'connector',
        initial: opcua_iiot_core_1.FsmConnectorStates.StateIdle,
        states: {
            idle: { on: {
                    INITOPCUA: opcua_iiot_core_1.FsmConnectorStates.StateInit,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            init: { on: {
                    OPEN: opcua_iiot_core_1.FsmConnectorStates.StateOpened,
                    CLOSE: opcua_iiot_core_1.FsmConnectorStates.StateClosed,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            opened: { on: {
                    SESSIONREQUEST: opcua_iiot_core_1.FsmConnectorStates.StateSessionRequested,
                    CLOSE: opcua_iiot_core_1.FsmConnectorStates.StateClosed,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            ...
            sessionRequested: { on: {
                    OPEN: opcua_iiot_core_1.FsmConnectorStates.StateOpened,
                    SESSIONACTIVATE: opcua_iiot_core_1.FsmConnectorStates.StateSessionActive,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            sessionActive: { on: {
                    OPEN: opcua_iiot_core_1.FsmConnectorStates.StateOpened,
                    SESSIONCLOSE: opcua_iiot_core_1.FsmConnectorStates.StateClosed,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            sessionClosed: { on: {
                    IDLE: opcua_iiot_core_1.FsmConnectorStates.StateIdle,
                    OPEN: opcua_iiot_core_1.FsmConnectorStates.StateOpened,
                    CLOSE: opcua_iiot_core_1.FsmConnectorStates.StateClosed,
                    SESSIONRESTART: opcua_iiot_core_1.FsmConnectorStates.StateSessionRestart,
                    LOCK: opcua_iiot_core_1.FsmConnectorStates.StateLocked,
                    UNLOCK: opcua_iiot_core_1.FsmConnectorStates.StateUnlocked,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            sessionRestart: { on: {
            ...
            locked: { on: {
                    ...
                    UNLOCK: opcua_iiot_core_1.FsmConnectorStates.StateUnlocked,
                    SESSIONRESTART: opcua_iiot_core_1.FsmConnectorStates.StateSessionRestart,
                    RECONFIGURE: opcua_iiot_core_1.FsmConnectorStates.StateReconfigured,
                    STOP: opcua_iiot_core_1.FsmConnectorStates.StateStopped,
                    RENEW: opcua_iiot_core_1.FsmConnectorStates.StateRenewed,
                    END: opcua_iiot_core_1.FsmConnectorStates.StateEnd
                }
            },
            unlocked: { on: {
...
function setListenerToClient(node) {
    ...
    node.iiot.opcuaClient.on('close', function (err) {
        if (err) {
    ...
    node.iiot.opcuaClient.on('backoff', function (number, delay) {
...
function logSessionInformation(node) {
    var _a;
...
function checkEndpoint(endpoint, errorHandler) {
...
exports.default = coreConnector;

//# sourceMappingURL=opcua-iiot-core-connector.js.map
