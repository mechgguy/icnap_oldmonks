...
export declare function readDataTypeDefinitionAndBuildType(session: IBasicSessionAsync2, dataTypeNodeId: NodeId, name: string, dataTypeFactory: DataTypeFactory, cache: ICache): Promise<void>;
